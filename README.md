...
- **响应式浏览器质量门槛**：覆盖 360–1920 px 的手机与桌面分辨率，并验证 Chrome、移动 WebKit、Edge、Firefox、键盘导航和减少动态效果模式。
...
项目支持 360–2560 CSS px。自动化验证覆盖 360×800、390×844、430×932 的手机视口，Chrome 的 1024×768、1280×720、1366×768、1440×900、1920×1080，以及桌面 Edge、Firefox、WebKit。
