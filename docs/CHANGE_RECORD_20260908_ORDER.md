...
Acceptance: no contact section/navigation/dead anchors; source order webArt, comment-vision-claw, tft-trait-atlas, swordshield-notes, nodestitch; relevant checks pass.
